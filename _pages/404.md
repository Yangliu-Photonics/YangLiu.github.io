...
I received my PhD in Electronic Engineering from Tsinghua University in China, specialising in neuromorphic computing, machine learning, and speech & EEG processing. I am under the supervison of Prof Lai Wang. My research encompasses:

- **Heterogeneous integration**, tackling temporally complex tasks such as spiking‑speech recognition and DVS gesture and image classification (based on Time-to-First-Spike coding).  
